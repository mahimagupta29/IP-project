...
<header><div class="container">
  ...
  <a href="final_reg.php#contact">Contact Us</a>
...
$conn = new mysqli('localhost', 'root', 'mahi', 'registration');
// Check connection
...
<section id="one" style="position:relative;left:300px;background: rgba(10, 0, 0, 0.5);width:600px;height:600px;font-family: Arial, Helvetica, sans-serif;">
	...
	<form method="post" action="final_reg.php">
    ...
    border: none;width:70%;padding: 7px;color:white;">
		...
		<center><button style="background: rgba(0, 0, 0, 0.5);color:white;width:50%;padding:7px;"type="submit" align="center" name="add">REGISTER</button></center>
