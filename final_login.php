...
<header><div class="container">
  ...
  <a href="final_login.php#contact">Contact Us</a>
  <a href="final_reg.php">New User</a>
</div>
</header></br></br></br>
<section id="two">
<a href="final_reg.php"><font face=" Bookman" color="white" size="5"><B>SIGN  UP</B></font><br></a>
</section>
<section id="one" style="position:relative;left:300px;background: rgba(10, 50, 80, 0.5);width:600px;height:400px;font-family: Arial, Helvetica, sans-serif;">
	<form method="post" action="final_login.php">
	<font color="#FFCDF5" size="4">
	<?php include('errors.php'); ?>
	</font><font color="#FFCDF5" size="10">	<legend><center><span id=cd >LOGIN</span></center></legend></font>
		<font color="#D5CFFF" size="5">

		<span id=ab >Username   :</span>  </br><input type="text" name="username" style="background: rgba(0, 0, 0, 0.5);display: inline-block;
    border: none;width:70%;padding: 7px;color:white;">
		</br>
		</br>
		<span id=ab >Password   :</span> </br> <input type="password" name="password" style="background: rgba(0, 0, 0, 0.5);display: inline-block;
    border: none;width:70%;padding: 7px;color:white;">
		</br></br></br>
		<center><button type="submit"  name="login_user" style="background: rgba(0, 0, 0, 0.5);color:white;width:50%;padding:7px;">Login</button></center>
